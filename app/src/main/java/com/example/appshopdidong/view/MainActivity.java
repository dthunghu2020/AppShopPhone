...
public class MainActivity extends AppCompatActivity {
    ...
    private void putDataPhone() {
        ...
        p30.setManHinh("Super AMOLED, 6.7, Full HD+");
        p30.setHeDieuHanh("Android 9.0 (Pie)");
        p30.setCpu("Exynos 7885 8 nhân 64-bit");
        p30.setBoNhoTrong("128 GB");
        p30.setRam("6 GB");
        p30.setCauHinhPhanCung("Chuẩn Kháng nước, Chuẩn kháng bụi + Sạc pin nhanh + Chặn cuộc gọi + Ghi âm cuộc gọi + Chặn tin nhắn + Màn hình luôn hiển thị AOD + Samsung Pay");
        p30.setTheSim("2 Nano SIM, Hỗ trợ 4G");
        p30.setDungLuongPin("3300 mAh, có sạc nhanh");
        p30.setBaoHanh("12 Tháng");
        ...
        p31.setManHinh("Super AMOLED, 6.4, Full HD+");
        p31.setHeDieuHanh("Android 9.0 (Pie)");
        p31.setCpu("Exynos 9610 8 nhân 64-bit");
        p31.setBoNhoTrong("128 GB");
        p31.setRam("6 GB");
        p31.setCauHinhPhanCung("Chuẩn Kháng nước, Chuẩn kháng bụi + Sạc pin nhanh + Chặn cuộc gọi + Ghi âm cuộc gọi + Chặn tin nhắn + Màn hình luôn hiển thị AOD + Samsung Pay");
        p31.setTheSim("2 Nano SIM, Hỗ trợ 4G");
        p31.setDungLuongPin("3300 mAh,, có sạc nhanh");
        p31.setBaoHanh("12 Tháng");
        ...
        p32.setManHinh("Super AMOLED, 6.21, Full HD+");
        p32.setHeDieuHanh("Android 8.1 (Oreo)");
        p32.setCpu("Snapdragon 845 8 nhân");
        p32.setBoNhoTrong("64 GB");
        p32.setRam("6 GB");
        p32.setCauHinhPhanCung("Mặt kính 2.5D + Đèn pin");
        p32.setTheSim("2 Nano SIM, Hỗ trợ 4G");
        p32.setDungLuongPin("3400 mAh, có sạc nhanh");
        p32.setBaoHanh("12 Tháng");
        ...
        p33.setManHinh("Super AMOLED, 6.26, Full HD+");
        p33.setHeDieuHanh("Android 8.1 (Oreo)");
        p33.setCpu("Qualcomm Snapdragon 660 8 nhân");
        p33.setBoNhoTrong("64 GB");
        p33.setRam("6 GB");
        p33.setCauHinhPhanCung("Mặt kính 2.5D + Đèn pin");
        p33.setTheSim("2 SIM Nano (SIM 2 chung khe thẻ nhớ), Hỗ trợ 4G");
        p33.setDungLuongPin("3350 mAh, có sạc nhanh");
        p33.setBaoHanh("12 Tháng");
        ...
        p34.setManHinh("IPS LCD, 5.99, Full HD+");
        p34.setHeDieuHanh("Android 8.1 (Oreo)");
        p34.setCpu("Qualcomm Snapdragon 660 8 nhân");
        p34.setBoNhoTrong("64 GB");
        p34.setRam("6 GB");
        p34.setCauHinhPhanCung("Mặt kính 2.5D + Đèn pin");
        p34.setTheSim("2 Nano SIM, Hỗ trợ 4G");
        p34.setDungLuongPin("3010 mAh, có sạc nhanh");
        p34.setBaoHanh("12 Tháng");
        ...
        p35.setManHinh("IPS LCD, 5.84, Full HD+");
        p35.setHeDieuHanh("Android 8.1 (Oreo)");
        p35.setCpu("Snapdragon 625 8 nhân 64-bit");
        p35.setBoNhoTrong("32 GB");
        p35.setRam("3 GB");
        p35.setCauHinhPhanCung("Mặt kính 2.5D + Đèn pin");
        p35.setTheSim("2 Nano SIM, Hỗ trợ 4G");
        p35.setDungLuongPin("4000 mAh,, có sạc nhanh");
        p35.setBaoHanh("12 Tháng");
        ...
        p36.setManHinh("IPS LCD, 6.3, Full HD+");
        p36.setHeDieuHanh("Android 9.0 (Pie)");
        p36.setCpu("Qualcomm Snapdragon 660 8 nhân");
        p36.setBoNhoTrong("64 GB");
        p36.setRam("4 GB");
        p36.setCauHinhPhanCung("Mặt kính 2.5D + Đèn pin");
        p36.setTheSim("2 Nano SIM, Hỗ trợ 4G");
        p36.setDungLuongPin("4000 mAh, có sạc nhanh");
        p36.setBaoHanh("12 Tháng");
        ...
        p37.setManHinh("Super AMOLED, 6.21, Full HD+");
        p37.setHeDieuHanh("Android 8.1 (Oreo)");
        p37.setCpu("Qualcomm Snapdragon 660 8 nhân");
        p37.setBoNhoTrong("64 GB");
        p37.setRam("4 GB");
        p37.setCauHinhPhanCung("Mặt kính 2.5D + Đèn pin");
        p37.setTheSim("2 Nano SIM, Hỗ trợ 4G");
        p37.setDungLuongPin("3400 mAh, có sạc nhanh");
        p37.setBaoHanh("12 Tháng");
        ...
        p38.setManHinh("Super AMOLED, 6.26, Full HD+");
        p38.setHeDieuHanh("Android 8.1 (Oreo)");
        p38.setCpu("Qualcomm Snapdragon 636 8 nhân 64-bit");
        p38.setBoNhoTrong("64 GB");
        p38.setRam("4 GB");
        p38.setCauHinhPhanCung("Mặt kính 2.5D + Đèn pin");
        p38.setTheSim("2 Nano SIM, Hỗ trợ 4G");
        p38.setDungLuongPin("4000 mAh, có sạc nhanh");
        p38.setBaoHanh("12 Tháng");
